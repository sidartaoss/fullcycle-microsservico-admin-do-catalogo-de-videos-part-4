...
class CategoryAPITest {
    ...
    @Nested
    @DisplayName("Create category with a valid input")
    ...
    class GetCategoryWithValidId {
        ...
        void Given_a_valid_category_id_When_calls_find_by_id_Then_should_return_category() throws Exception {
            ...
            final var expectedIsActive = aCategory.getActivationStatus();
    ...
    class ActivateWithValidInput {
        ...
        void Given_a_valid_input_When_calls_activate_category_Then_should_return_an_active_category_id()
            ...
            when(activateCategoryUseCase.execute(anyString()))
            ...
            response
                    ...
                    .andExpect(header().string("Content-Type", MediaType.APPLICATION_JSON_VALUE))
                    .andExpect(jsonPath("$.id", equalTo(expectedId)));
            verify(activateCategoryUseCase, times(1)).execute(expectedId);
        }
    }
        ...
        void Given_an_invalid_id_When_calls_activate_genre_Then_should_return_not_found_exception()
            ...
            when(activateCategoryUseCase.execute(anyString()))
                    .thenThrow(NotFoundException
                            .with(Category.class, CategoryID.from(expectedId)));
    ...
    class DeactivateWithValidId {
        ...
        @Test
        void Given_a_valid_id_When_calls_deactivate_category_Then_should_return_an_inactivated_category_id()
                throws Exception {
            // Given
            final var expectedId = "123";

            when(deactivateCategoryUseCase.execute(anyString()))
            ...
            response
                    ...
                    .andExpect(header().string("Content-Type", MediaType.APPLICATION_JSON_VALUE))
                    .andExpect(jsonPath("$.id", equalTo(expectedId)));
            verify(deactivateCategoryUseCase, times(1)).execute(expectedId);
        }
    }
    ...
    class ListCategoriesWithValidParams {
        ...
        void Given_a_valid_params_When_calls_list_categories_Then_should_return_categories()
            ...
            when(listCategoriesUseCase.execute(any(SearchQuery.class)))
            ...
            response
                    ...
                    .andExpect(jsonPath("$.items[0].activation_status", is(equalTo(aCategory.getActivationStatus().toString()))))
